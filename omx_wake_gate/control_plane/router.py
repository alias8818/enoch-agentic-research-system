...
function paperStatusLabel(s){const v=String(s||''); const map={draft_review:'First draft',publication_draft:'Publication-ready draft',draft_generating:'Writing draft',publication_generating:'Finalizing draft',human_review_required:'Needs policy decision'}; return map[v]||titleCase(v);}
function automationStatusLabel(s){const v=String(s||''); const map={unreviewed:'Waiting for automation',triage_ready:'Ready for automation',in_review:'Automation running',changes_requested:'Automation changes needed',blocked:'Automation blocked',approved_for_finalization:'Ready to package',finalized:'Finalized',rejected:'Rejected'}; return map[v]||titleCase(v);}
