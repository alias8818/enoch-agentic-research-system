    ...
    *,
    ...
    if (provider_id or "").strip().lower() not in {"", "env", "synthetic"} and (
        ...
        return {
            ...
            "reason": f"synthetic budget check skipped for provider {provider_id}",
