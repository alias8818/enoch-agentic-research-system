...
STATE_REDUCTION_PLAN: Final[dict[str, dict[str, dict[str, str]]]] = {
    ...
    "papers.paper_status": {
        ...
        "publication_draft": _decision(OperatorLane.AUTOMATE_PUBLICATION, "keep", reason="publication readiness also requires required evidence paths and finalized automation package"),
    ...
    "publication_automation_items.automation_status": {
        ...
        "finalized": _decision(OperatorLane.READY_TO_PUBLISH, "keep", reason="finalization package and required evidence paths are ready"),
