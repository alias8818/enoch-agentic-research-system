...
- **Code repo:** packaged, CI-enabled, protected, and staged privately at `alias8818/enoch-agentic-research-system`.
- **Corpus repo:** packaged, quality-scanned, protected, and staged privately at `alias8818/enoch-ai-research-corpus`.
...
- [ ] Re-run final CI and secret scans on both repos immediately before flipping visibility.
- [ ] Confirm branch protection remains enabled on both repos after visibility changes.
- [ ] Flip `alias8818/enoch-agentic-research-system` public.
- [ ] Flip `alias8818/enoch-ai-research-corpus` public.
- [ ] Verify public anonymous access to both READMEs, the site, and all highlighted corpus links.
- [ ] Add/confirm final public URLs in README, launch site copy, and announcement drafts.
- [ ] Verify the credits section names the tooling accurately:
