...
- [x] Packaged the corpus repo with 160 AI-generated research artifacts, provenance metadata, claim-ledger files, evidence bundles, packaging/provenance reports, and a strict claim/evidence audit report.
