...
- [x] Add GitHub issue/PR templates, CODEOWNERS, CI, Dependabot, security policy, and protection automation.
- [x] Apply available private-repo settings: issues on, discussions on, projects/wiki off, squash-only merges, branch delete on merge.
- [ ] Apply branch protection after repos are public or branch protection becomes available for private repos on the account.
