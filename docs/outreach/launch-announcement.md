...
I’m releasing Enoch, a local agentic research control plane, plus a corpus of 375 AI-generated research artifacts.
...
The interesting part is the system around them: idea intake, scoring, queue state, maintenance pause, worker preflight, wake-gated execution, process/telemetry truth, evidence sync, claim ledgers, paper rewriting, packaging/provenance lint scans, and a dashboard for seeing what the system is actually doing. Enoch is built with FastAPI/LangGraph-era control-plane boundaries and operated through Codex/OMX automation, including oh-my-codex.
...
> 375 AI-generated research artifacts produced by Enoch, packaged with provenance metadata, evidence bundles, claim-ledger files, manifests, packaging/provenance reports, and a strict claim/evidence audit report. Current public status: 375/375 packaging/provenance lint passes and 2/375 strict claim/evidence audit pass.
...
1. “I’m releasing Enoch: an agentic research control plane plus 375 AI-generated research artifacts.”
