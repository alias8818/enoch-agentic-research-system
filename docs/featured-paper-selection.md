...
1. **The system is the product.** Enoch is a control plane for autonomous research: intake, queueing, dispatch gates, worker preflight, worker-gated completion, evidence sync, packaging/provenance lint checks, and publication-style packaging.
