...
it('maps backend hash actions to the legacy dashboard until V2 owns subpages', () => {
  ...
  expect(legacyDashboardHref('/control/dashboard#events')).toBe('/control/dashboard#events')
})
