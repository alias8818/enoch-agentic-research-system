...
def main() -> int:
    ...
    require("1/159" in launch, "launch missing strict audit 1/159 status", failures)
    ...
    require("1/159" in profile, "profile missing strict audit 1/159 status", failures)
    ...
    require(manifest.get("strict_claim_evidence_pass_count") == 1, "manifest strict audit pass count should be 1 after first evidence contract pass", failures)
