...
def main() -> int:
    ...
    require("0/159" in launch, "launch missing strict audit 0/159 status", failures)
    ...
    require("0/159" in profile, "profile missing strict audit 0/159 status", failures)
    ...
    require(manifest.get("strict_claim_evidence_pass_count") == 0, "manifest strict audit pass count should be 0 until evidence contract is satisfied", failures)
