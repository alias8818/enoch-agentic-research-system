...
def main() -> int:
    ...
    print(json.dumps({"output": str(args.output), "artifact_count": artifact_count, "packaging_provenance_pass_count": pass_count, "strict_claim_evidence_pass_count": strict_pass}, indent=2))
    return 0
